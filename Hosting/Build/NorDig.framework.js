...
var ASM_CONSTS = {
  4901612: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4901667: ($0) => { performance.now = function() { return $0; }; },  
 4901715: ($0) => { performance.now = function() { return $0; }; },  
 4901763: () => { performance.now = Module['emscripten_get_now_backup']; }
};
