...
var ASM_CONSTS = {
  4866032: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4866087: ($0) => { performance.now = function() { return $0; }; },  
 4866135: ($0) => { performance.now = function() { return $0; }; },  
 4866183: () => { performance.now = Module['emscripten_get_now_backup']; }
};
