...
var ASM_CONSTS = {
  4969520: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4969575: ($0) => { performance.now = function() { return $0; }; },  
 4969623: ($0) => { performance.now = function() { return $0; }; },  
 4969671: () => { performance.now = Module['emscripten_get_now_backup']; }
};
