...
var ASM_CONSTS = {
  4969488: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4969543: ($0) => { performance.now = function() { return $0; }; },  
 4969591: ($0) => { performance.now = function() { return $0; }; },  
 4969639: () => { performance.now = Module['emscripten_get_now_backup']; }
};
